...
class Account {
    ...
    public function studentRegister($un, $fn, $ln, $em, $pw, $pw2, $dob, $level, $skype) {
        ...
        if(empty($this->errorArray) == true) {
            ...
            return $this->insertStudentDetails(studentID, $un, $fn, $ln, $em, $pw, '', '', $dob, $level, '', $skype);
        } else {
            return false;
        }
    }
    ...
    public function teacherRegister($un, $fn, $ln, $em, $pw, $pw2, $dob, $nation, $edu, $skype) {
        ...
        if(empty($this->errorArray) == true) {
            // if no errors, insert data into db
            return $this->insertTeacherDetails(teacherID, $un, $fn, $ln, $em, $pw, '', '', $dob, $nation, '', $edu, '', '', '', $skype);
        } else {
            return false;
        }
    }
