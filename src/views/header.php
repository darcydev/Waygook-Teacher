  ...
  <nav class="navbar navbar-expand-lg navbar-dark primary-color">
    ...
    <div class="collapse navbar-collapse" id="basicExampleNav">
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a id="profile-nav-link" class="nav-link" href="/src/views/profile.php">Profile</a>
        </li>
        <li class="nav-item">
          <a id="inbox-nav-link" class="nav-link" href="/src/views/inbox.php">Inbox</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <a id="logout-nav-link" class="nav-link" href="/src/views/logout.php">Logout</a>
        </li>
